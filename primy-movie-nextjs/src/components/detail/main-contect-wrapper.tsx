...
export default function MainContectWrapper({
  ...
  return (
    // <div
    //   className={`rounded-tl-xl rounded-tr-xl sm:px-[25px] sm:pt-[25px] pt-[15px] ${
    //     theme == "light"
    //       ? "bg-white shadow-lg shadow-slate-400"
    //       : "bg-[#060d17]"
    //   } w-[100%]  relative z-0 min-h-[800px] -mt-[75px] mr-auto ml-auto mb-0 max-w-[1170px] `}
    // >
    theme == "light" ? (
